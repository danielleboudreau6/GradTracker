  <div class="content-wrapper">
    ...
    <?php
        ...
        ?>
        <div class="col-lg-6">
            <form name="editTitleForm" id="editTitleForm" novalidate method="post">
                ...
                <button type="submit" class="btn btn-primary" id="addStudentButton">Edit Title</button>
